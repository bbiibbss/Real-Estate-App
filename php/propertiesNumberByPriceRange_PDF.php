<?php
	...
	$pdf->WriteHTML('<h1>Número de propriedades por Intervalo de Preço</h1><br>');

	$pdf->WriteHTML(''.$property->getPropertiesNumberByRangePDF().'');

	$pdf->SetFooter('Pág. {PAGENO}');
	
	$filename = "properties_by_price_range_" . date('d-m-Y') . ".pdf";
