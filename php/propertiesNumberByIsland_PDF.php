<?php
	...
	$pdf->WriteHTML('<h1>Número de propriedades por Ilha</h1><br>');

	$pdf->WriteHTML(''.$property->getPropertiesNumberByIslandPDF().'');

	$pdf->SetFooter('Pág. {PAGENO}');
	
	$filename = "properties_by_island_" . date('d-m-Y') . ".pdf";
