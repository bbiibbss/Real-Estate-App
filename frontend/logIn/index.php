<?php
    ...
    if($userRow["PK_user_type_id"] == 2){
        $auth_user->redirect('../../backend/manager/index.php');
    }
    if($userRow["PK_user_type_id"] == 3){
        $auth_user->redirect('../../backend/admin/index.php');
    }
...
<body>
    ...
    <div class="page w3-content w3-card-2 w3-white">
        ...
        <div class="row">
            <?php
                $property->getAllFeaturedPropertiesLogin($user_id);
            ?>
        </div>
    </div>
