<?php
	...
	$pdf->WriteHTML('<h1>Número de propriedades por freguesia</h1><br>');

	$pdf->WriteHTML(''.$property->getPropertiesNumberByParishPDF().'');

	$pdf->SetFooter('Pág. {PAGENO}');
	
	$filename = "properties_by_parish_" . date('d-m-Y') . ".pdf";
